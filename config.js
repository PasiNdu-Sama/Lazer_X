...
module.exports = {
    ...
    OWN_NUMBER: process.env.OWNER_NUMBER === undefined ? '94771375357' : process.env.OWN_NUMBER,
    OWN_NAME: process.env.OWNER_NAME === undefined ? 'Moshiro360 >•<' : process.env.OWN_NAME,
    BOT_NAME: process.env.BOT_NAME === undefined ? 'Lazer_X' : process.env.BOT_NAME,
    ST_PKG: process.env.STICKER_PACKAGE === undefined ? '94757845360' : process.env.ST_PKG,
